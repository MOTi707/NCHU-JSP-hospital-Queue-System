...
<body>
<h1 class="section-title">按科室名称挂号</h1>

<div class="container">
    <form method="get">
        <div class="search-section">
            <input type="text" class="search-input" name="keyword"
                   placeholder="输入科室（支持模糊搜索）"
        ...
        <%
            ...
            if (keyword != null && !keyword.isEmpty()) {
                ...
                try {
                    ...
                    String sql = """
                            select doctor.name as name,department.name as department,doctor.position as position
                            from doctor
                            join department
                            on doctor.departmentID=department.departmentID
                            """
                            +
                            "where department.name like '%" + keyword
                            +
                            """
                                    %'
